...
var stressReaders = []stressReader{
	...
	{"TeleprompterWatchResume", func(h *Host) { _, _ = h.TeleprompterWatchResume("{track}") }},
	{"TeleprompterUnwatchResume", func(h *Host) { _, _ = h.TeleprompterUnwatchResume() }},
	{"ReadAloudReaperState", func(h *Host) { _, _ = h.ReadAloudReaperState("c-0001") }},
	{"TeleprompterReaperInput", func(h *Host) { _, _ = h.TeleprompterReaperInput() }},
	...
	{"FindingsList", func(h *Host) { _, _ = h.FindingsList(FindingsQuery{}) }},
	{"FindingsGet (unknown finding)", func(h *Host) { _, _ = h.FindingsGet("missing") }},
	{"FindingsReview (unknown finding)", func(h *Host) { _, _ = h.FindingsReview("missing", "", "accepted", "") }},
	{"FindingsSummary", func(h *Host) { _, _ = h.FindingsSummary() }},
	{"FindingsReaperStatus", func(h *Host) { _, _ = h.FindingsReaperStatus() }},
	...
	{"TakeComparisonCancel (nothing running)", func(h *Host) { _, _ = h.TakeComparisonCancel() }},
	{"TakeComparisonStart (unknown finding)", func(h *Host) { _, _ = h.TakeComparisonStart("missing") }},
	{"FindingsAddMarker (unknown finding)", func(h *Host) { _, _ = h.FindingsAddMarker("missing") }},
	{"MeasureState", func(h *Host) { _, _ = h.MeasureState() }},
	{"MeasureCancel (nothing running)", func(h *Host) { _, _ = h.MeasureCancel() }},
	{"MeasureAnalyze (not picked)", func(h *Host) { _, _ = h.MeasureAnalyze([]string{"C:/missing.wav"}) }},
	{"DeliveryProfiles", func(h *Host) { _, _ = h.DeliveryProfiles() }},
	{"DeliverySelectProfile (unknown profile)", func(h *Host) { _, _ = h.DeliverySelectProfile("project", "missing", "") }},
