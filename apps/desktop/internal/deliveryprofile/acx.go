	...
	return Profile{
		...
		Rules: []Rule{
			...
			},
			{
				...
				Min: number(0.5), Max: number(5), Level: LevelRequired, CheckedBy: CheckedNotYet,
				NotCheckedWhy: "Not checked by the app yet: measuring room tone at the file's edges comes later.",
			...
			},
			{
				...
				Min: number(1), Max: number(5), Level: LevelRequired, CheckedBy: CheckedNotYet,
				NotCheckedWhy: "Not checked by the app yet: measuring room tone at the file's edges comes later.",
