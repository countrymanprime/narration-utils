...
export const FEEDBACK_CATALOG: Record<string, FeedbackRow> = {
  ...
  'src/components/home/Home.tsx::manuscriptImportState#1': row('timer', 'instant', 'dialog', 'dialog', 'poll', 'dialog', 'no', 'ok', 'The import dialog is modal, so the narrator cannot leave Home while it runs; a job-end event carries the outcome for the notifier (P5).'),
  ...
  'src/components/home/Home.tsx::manuscriptImportCommit#1': row('click', 'job', 'dialog', 'host', 'poll', 'dialog', 'no', 'ok', 'Modal import dialog with real progress; a job-end event carries the outcome (P5).'),
  ...
  'src/components/manuscript/Manuscript.tsx::guideCreate#1': row('click', 'python', 'none', 'none', 'ui', 'unhandled', 'no', 'gap', '"Add to Story Bible" spawns Python (about 0.6 s), shows nothing until it finishes and has no catch.', 'P3'),
  ...
  'src/components/proofing/Transcript.tsx::transcriptStart#1': row('click', 'job', 'dialog', 'host', 'ui', 'toast', 'no', 'ok', 'The phase moves to preparing from the state event; the host refuses a second run. Its end is reported by a job-end event (P5).'),
  ...
  'src/components/settings/UpdateDownloadDialog.tsx::updateJobState#1': row('timer', 'download', 'dialog', 'na', 'poll', 'dialog', 'no', 'ok', 'Modal dialog with real byte progress (ADR 0072); a job-end event carries the outcome (P5).'),
  ...
  'src/components/storybible/Guide.tsx::guideBuildState#1': row('timer', 'instant', 'dialog', 'dialog', 'poll', 'dialog', 'no', 'gap', 'The rebuild dialog and its success toast belong to this page: leaving mid-build loses both.', 'P5'),
  'src/components/storybible/Guide.tsx::guideBuild#1': row('click', 'job', 'none', 'none', 'poll', 'toast', 'no', 'gap', 'The icon button does not change while the start call is in flight; a second click is refused by the host with a toast.', 'P3'),
  'src/components/storybible/GuideDetail.tsx::guidePreview#1': row('click', 'python', 'none', 'none', 'ui', 'toast', 'na', 'gap', 'An uncached preview loads a Piper voice in Python and nothing changes until sound starts.', 'P3'),
  'src/components/storybible/GuideDetail.tsx::guideEdit#1': row('click', 'python', 'none', 'none', 'toast', 'toast', 'na', 'gap', 'One Save is four sequential Python spawns (about 1.3 s) with no in-flight state and no guard.', 'P3'),
  ...
  'src/components/storybible/GuideDetail.tsx::guideCreate#1': row('click', 'python', 'none', 'none', 'toast', 'toast', 'na', 'gap', 'Choosing a category creates the entry through a Python spawn (about 0.6 s) with no in-flight state.', 'P3'),
  'src/components/storybible/GuideDetail.tsx::guideRescan#1': row('click', 'python', 'none', 'none', 'toast', 'toast', 'na', 'gap', 'A Python spawn (about 0.4 s) with no in-flight state.', 'P3'),
  'src/components/storybible/GuideDetail.tsx::guideSetLocked#1': row('click', 'python', 'none', 'none', 'toast', 'toast', 'na', 'gap', 'A Python spawn (about 0.3 s) with no in-flight state.', 'P3'),
  'src/components/storybible/GuideDetail.tsx::guideUnrelate#1': row('click', 'python', 'none', 'none', 'toast', 'toast', 'na', 'gap', 'A Python spawn (about 0.3 s) with no in-flight state.', 'P3'),
  'src/components/storybible/GuideDetail.tsx::guideRelate#1': row('click', 'python', 'none', 'none', 'toast', 'toast', 'na', 'gap', 'A Python spawn (about 0.3 s) with no in-flight state.', 'P3'),
  'src/components/storybible/GuideDetail.tsx::guideDelete#1': row('click', 'python', 'none', 'none', 'toast', 'toast', 'na', 'gap', 'A Python spawn (about 0.3 s) behind a confirm that stays clickable.', 'P3'),
  'src/components/storybible/GuideDetail.tsx::guideMerge#1': row('click', 'python', 'none', 'none', 'toast', 'toast', 'na', 'gap', 'A Python spawn (about 0.3 s) behind a confirm that stays clickable.', 'P3'),
