...
export const FEEDBACK_CATALOG: Record<string, FeedbackRow> = {
  ...
  'src/components/delivery/DeliveryPage.tsx::settingsForScope#1': row('mount', 'file-io', 'na', 'na', 'ui', 'inline', 'na', 'ok', 'Reads the project Delivery limits the page judges against; when they cannot be read the limits panel says so inline and every value is only reported, never marked as within a limit.'),
