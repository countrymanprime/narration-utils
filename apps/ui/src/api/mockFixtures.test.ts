...
// fieldSchemas). It once offered seven more, one per entity kind, and the app writes every colour setting inline on <html>,
// where it beats both theme blocks of styles.css: in the dark theme every capture and every axe pass then showed the light
// hexes of the entity colours, and the dark tokens (ADR 0059) never rendered.
