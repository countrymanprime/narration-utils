...
/** Splits result.text on every unresolved token's own bracketed placeholder ("[Author]") so it can be rendered with a
 * highlighted chip in place, matching Open Question C6: "a highlighted placeholder chip and an unresolved-token
 * count", never silently rendered as empty text. */
function previewParts(result: CreditsRenderResult): (string | { token: string })[] {
