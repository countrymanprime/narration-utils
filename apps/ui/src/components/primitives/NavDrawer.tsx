    ...
    >
      <Drawer.Portal>
        ...
        <Drawer.Viewport className="fixed inset-0 z-[70] flex items-stretch justify-start">
          <Drawer.Popup className="relative flex h-full w-[min(17rem,86vw)] [transform:translateX(var(--drawer-swipe-movement-x,0px))] flex-col bg-[var(--surface)] shadow-[var(--shadow-lg)] outline-none">
