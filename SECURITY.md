...
- Path traversal, command injection, or unsafe file handling when opening projects, manuscripts, or archives, or when a
  ...
  which the host builds from the saved REAPER project).
