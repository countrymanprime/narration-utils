...
(`apps/ui/tests/visual/`) and are kept current by the `doc-screenshot-sync` skill when the UI
changes.

## Pages

Read them in order the first time, or jump straight to the page you need.
