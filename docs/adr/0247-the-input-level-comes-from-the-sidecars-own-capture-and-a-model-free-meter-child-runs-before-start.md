...
- The meter in the bar and the popover (a `useInputLevel` hook with peak-hold that respects reduced motion) is the UI half, built on this contract by the UI lane. The owner's check that the meter moves with their own microphone is pending (#510).
