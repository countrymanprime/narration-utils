...
- Any new consumer of `/media` must go through `authorizedMediaSource`'s project-track-source check; nothing should ever add a raw-path passthrough to this route, or it becomes an arbitrary local file read.
