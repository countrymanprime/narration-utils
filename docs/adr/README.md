...
| [0242](0242-a-pull-request-stacked-on-another-skips-the-playwright-suites-and-the-windows-build-until-it-targets-main.md) | A pull request stacked on another skips the Playwright suites and the Windows build until it targets main | Accepted |
| [0243](0243-the-playwright-suites-run-sharded-in-ci-and-a-check-run-judges-the-visual-suite-across-its-shards.md) | The Playwright suites run sharded in CI, and a check run judges the visual suite across its shards | Accepted |
