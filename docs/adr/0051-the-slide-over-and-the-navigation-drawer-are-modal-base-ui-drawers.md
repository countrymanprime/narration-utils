...
- **Swipe.** The Drawer's swipe-to-dismiss gesture comes with it (`swipeDirection` right and left) and follows the pointer through `--drawer-swipe-movement-x`; mouse text selection inside the panel was checked in Chromium and is unaffected.
