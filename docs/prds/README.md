...
| [Base UI Primitive Foundation](../adr/0047-the-ui-primitives-wrap-base-ui-and-app-code-never-imports-it.md) | Feature | 6 | The mechanism parts of the dialog and component-accessibility PRDs (Dialog, Tooltip, Field) |
