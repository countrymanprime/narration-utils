...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Signal contract and engine | `apps/desktop/internal/stages` types, provider interface, pure engine, verdicts, basis key, contract doc; exhaustive table tests; fake providers | pending | EL-1 to EL-6, RC | - | - |
