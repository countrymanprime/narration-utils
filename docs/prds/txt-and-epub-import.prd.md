...
| --- | --- | --- |
| 1 | `apps/desktop/internal/importer/{importer,formats,txt}.go` and tests, `apps/desktop/bindings.go:294`, `apps/desktop/cmd/manuscript-import/main.go`, `apps/ui/src/api/contracts/manuscript.ts`, `Home.tsx:135`, `mockApi.ts`, `tests/fixtures/*`, `apps/desktop/go.mod` | [import-review-redesign](import-review-redesign.prd.md) Phase 1 (extracts the review body from `Home.tsx`; land it first or rebase), [import-structure](import-structure-toc-and-characters.prd.md) Phase 1 (`model.go`, `docx.go`, `markdown.go`), [boundary-schema-validation](boundary-schema-validation.prd.md) (contracts), Base UI foundation (`go.mod` is separate, `package.json` is not touched) |
...
| 4 | `detect.go`, `docs/**`, `docs/images/ui/*`, `docs/adr/`, `docs/prds/README.md` | ADR number and the README index; [verification-and-code-health-tooling](verification-and-code-health-tooling.prd.md) Phase 6 (if it has landed, add the two fuzz targets there, otherwise it adds them) |
