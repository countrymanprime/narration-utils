...
| 1 | Normalised matching | `CanonicalLabel` pre-pass in Go and Python, markers, parity cases, fuzz, table tests from the Evidence table; ADR amending ADR 0110 | pending | 0 | S5, S9 | - |
