...
| No ADR expected | A bullet in `design-system.md` | A new ADR | No ADR recorded the old order; `architecture-decision-records` decides at merge if the reserved-slot rule reads as a recorded decision |
