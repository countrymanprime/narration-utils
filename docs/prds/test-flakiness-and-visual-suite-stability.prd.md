...
*Status: in delivery (stack S07, issue #80). Phase 1 is complete; phases 2 to 5 follow in the same stack; phase 6 waits for the palette stack (S12) and a kit slot, phase 7 stays a deferred spike. This PRD stays until those two are done or dropped.*
