...
*Status: in delivery (stack S07, issue #80). Phases 1 to 3 are complete; phases 4 and 5 follow in the same stack; phase 6 waits for the palette stack (S12) and a kit slot, phase 7 stays a deferred spike. This PRD stays until those two are done or dropped.*
