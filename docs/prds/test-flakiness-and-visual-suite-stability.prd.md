...
*Status: in delivery (stack S07, issue #80). Phases 1 and 2 are complete; phases 3 to 5 follow in the same stack; phase 6 waits for the palette stack (S12) and a kit slot, phase 7 stays a deferred spike. This PRD stays until those two are done or dropped.*
