...
- **Delivered:** phase 2 (#412, the settings number kind and the narrator's own delivery limits; ADR 0155, Proposed); phase 1 (the measurement job and its four bindings, `MeasurePickFiles/Analyze/State/Cancel`, with real progress, cancel, a range and the file fingerprint; ADR 0156, Proposed; `hostAPIVersion` 44).
- **Left:** phases 3 to 11.
- **Needs the owner:** review ADRs 0155 and 0156; the REAPER checks of phase 10 (preview and apply) when it is built.
