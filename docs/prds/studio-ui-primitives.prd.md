...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Token batch | Meter-zone and badge-fill tokens, the scoped booth block (Q1), all in both themes and `PAIRS`; `tokenContrast.ts` reads the booth block | pending | - (runs alone) | - | - |
| 2 | Kbd | Key cap primitive | pending | with 3-10 | 1 | - |
