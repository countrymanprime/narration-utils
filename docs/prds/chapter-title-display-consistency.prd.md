...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Rule, formatter, primitive, guard | `chapterName.ts`, `TitleSubtitle` primitive and stories, the source-scan guard at today's ceiling, the heading cases in the mixed-rows mock | pending | - | Q1-Q3, Q5 | - |
