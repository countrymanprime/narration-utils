...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Registry core (U) | `src/input/`: catalog, gestures, `InputSource`, KeyboardSource, router, scopes, target guard, conflict function, `useCommand`. Listener guard scan with a ratchet allowlist. ADR 0361 to Accepted | pending | alone | - | - |
