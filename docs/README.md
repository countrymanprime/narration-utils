...
| [Review](guides/using-the-app/review.md) | Implemented | One queue of the findings from Transcript Compare and the Story Bible: filter, sort, see the evidence, accept, dismiss or defer with a note, and go to, loop or mark a finding in REAPER ([findings contract](architecture/findings-contract.md)). |
