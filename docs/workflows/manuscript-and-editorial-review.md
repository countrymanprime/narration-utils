...
3. Record or assemble a chapter on a REAPER track whose name maps to the Word heading.
4. Run Transcript Compare. Review its diff and take markers, then accept/dismiss/defer each finding in the future dashboard.
