...
| `acx.format` | MP3, 192 kbps or higher, constant bit rate | file | Measured on a picked MP3 since PRD Phase 6 (ADR 0237): the frame headers give the bitrate (at least 192 kbps) and whether every frame shares it (CBR); not checked on a WAV render | verified (2026-09-23) | |
