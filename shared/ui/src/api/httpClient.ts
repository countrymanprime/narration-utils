...
export const httpClient: NarrationApi = {
  ...
  selectManuscript: () => post<ManuscriptFileSelection>('/api/manuscript/select-file'),
  manuscriptImportState: (jobId) => get<WorkJob>(`/api/manuscript/import/${encodeURIComponent(jobId)}`),
  manuscriptImportPreview: (jobId, options) => post<WorkJob>(`/api/manuscript/import/${encodeURIComponent(jobId)}/preview`, options),
  manuscriptImportCommit: (jobId, options) => post<WorkJob>(`/api/manuscript/import/${encodeURIComponent(jobId)}/commit`, options),
  manuscriptImportCancel: (jobId) => post(`/api/manuscript/import/${encodeURIComponent(jobId)}/cancel`),
  manuscriptLegacyPreview: () => post<ManuscriptFileSelection>('/api/manuscript/import/legacy-preview'),
